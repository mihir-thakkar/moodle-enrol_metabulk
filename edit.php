...
$PAGE->set_url('/enrol/metabulk/edit.php', array('courseid' => $course->id, 'instanceid' => $instanceid));
$PAGE->set_pagelayout('admin');

$returnurl = new moodle_url('/enrol/instances.php', array('id' => $course->id));
$pageurl = new moodle_url('/enrol/metabulk/edit.php', array('courseid' => $course->id, 'instanceid' => $instanceid));
...
if ($mform->is_cancelled()) {
    ...
    if($instance->id) {
        ...
        $instance->status       = $data->status; // 1 for Disabled and 0 for Enabled.        
